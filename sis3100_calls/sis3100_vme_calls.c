...
/* Modified:         05.11.03                                                */
/* Modified:         21.06.04                                                */
/* Modified:         15.12.04 MKI driver 2.6.x V2.02                         */
/*                                                                           */
/* Author:           TH                                                      */
/*                                                                           */
...
int vme_A24DMA_D16_read(int p, u_int32_t vme_adr, u_int16_t* vme_data,
...
int vme_A24DMA_D16_write(int p, u_int32_t vme_adr, u_int16_t* vme_data,
...
#else
  error = (ioctl(p, SIS1100_REMOTE_CTRL_READ, &reg)<0)  ;
#endif
...
#else
  error = (ioctl(p, SIS1100_REMOTE_CTRL_WRITE, &reg)<0)  ;
#endif
  return error ;
}
